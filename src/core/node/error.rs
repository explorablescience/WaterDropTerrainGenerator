...
use crate::core::node::message::NodeMessageSeverity;

/// An error produced while working with a [`Node`](super::Node) or the
/// [`NodeGraph`](crate::core::graph::NodeGraph) it belongs to.
#[derive(Debug)]
pub enum NodeError {
